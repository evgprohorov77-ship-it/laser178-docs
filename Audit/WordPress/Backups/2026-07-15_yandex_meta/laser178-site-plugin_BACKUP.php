...
function l178_enqueue_styles() {
    ...
    $css = "
        :root {
            ...
            --laser-text: #7dd3fc !important;
            --laser-text-muted: #38bdf8 !important;
        }
...
<div style="padding: 80px 20px; max-width: 1200px; margin: 0 auto;">
    ...
    <div class="laser-lightbox" id="laserLightbox" aria-hidden="true">
        ...
        <div class="laser-lightbox-img-wrap"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" alt="" id="laserLightboxImg"/></div>
    </div>
</div>
...
function l178_calculator_shortcode() {
    ...
    <style>
        ...
        #l178-calc .element-qty { width: 64px; padding: 6px 4px; border-radius: 4px; border: 1px solid var(--laser-border); background: var(--laser-bg); color: var(--laser-text); text-align: center; font-size: 14px; -moz-appearance: textfield; }
                ...
                <div class="calc-modal-body">
                    <div class="calc-group">
                        ...
                        <div class="laser-services-list" id="laser-modal-services">
                            <div class="laser-service-item">
                                <label><input type="checkbox" value="rust" data-rate="12500"> Очистка ржавчины</label>
                            ...
                            <div class="laser-service-item">
                                <label><input type="checkbox" value="paint" data-rate="9375"> Очистка краски</label>
                            ...
                            <div class="laser-service-item">
                                <label><input type="checkbox" value="anticor" data-rate="14063"> Очистка старого антикор покрытия</label>
                    ...
                    <div class="calc-group">
                        ...
                        <div class="checkbox-grid" id="laser-modal-addons">
                            <label><input type="checkbox" value="zinc" data-rate="1000"> Нанесение цинкового грунта</label>
                            <label><input type="checkbox" value="epoxy" data-rate="500"> Нанесение эпоксидного грунта для улучшения адгезии материалов</label>
                        </div>
                    </div>
                        ...
                        <div class="checkbox-grid">
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Маслянистый антикор для обработки внутренних полостей (пороги, стойки, лонжероны). Расход: до 5 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Проникающий состав для обработки уже имеющейся ржавчины внутри полостей. Расход: до 7 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Тягучий антикор для скрытых полостей, повышенная защита. Расход: до 5 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Битумно-резиновое покрытие для защиты днища и арок от сколов и коррозии. Расход: до 8 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Суперэластичное покрытие для днища и арок, стойкое к механическим повреждениям. Расход: до 10 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Антигравийное покрытие для защиты порогов, арок и бамперов от сколов. Расход: до 10 баллонов.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Жидкий воск для скрытых полостей и труднодоступных участков. Расход: до 10 баллонов.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Консервация металлических деталей моторного отсека. Расход: до 1 баллона.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Специальный антикор для алюминиевых и оцинкованных деталей. Расход: до 1 баллона.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Высокотемпературная краска для защиты выхлопной системы и прилегающих деталей. Расход: до 1 баллона.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Обезжириватель и очиститель для подготовки поверхности перед нанесением антикора. Расход: до 5 л.</small>
                        ...
                        <div class="checkbox-grid">
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Антигравийное покрытие для защиты порогов и арок от сколов и царапин. Расход: до 6 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Текстурный антигравий для защиты порогов и арок. Расход: до 5 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Очистка и обезжиривание поверхностей перед нанесением антикора. Расход: до 3 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Эластичное полиуретановое покрытие для защиты днища от ударов и коррозии. Расход: до 10 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Мастика для защиты днища, порогов и арок от коррозии. Расход: до 10 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Цинковый грунт для антикоррозийной обработки металла. Расход: до 2 кг.</small>
                                    <div class="element-qty-wrap"><button type="button" class="element-qty-btn" data-action="dec" data-for="onb-cerberus-zn">−</button><input type="number" class="element-qty" min="0.1" step="0.1" value="0.1" data-for="onb-cerberus-zn"><button type="button" class="element-qty-btn" data-action="inc" data-for="onb-cerberus-zn">+</button></div>
                                </div>
                            </label>
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Эпоксидный грунт для улучшения адгезии и защиты металла. Расход: до 2 кг.</small>
                                    <div class="element-qty-wrap"><button type="button" class="element-qty-btn" data-action="dec" data-for="onb-excalibur">−</button><input type="number" class="element-qty" min="0.1" step="0.1" value="0.1" data-for="onb-excalibur"><button type="button" class="element-qty-btn" data-action="inc" data-for="onb-excalibur">+</button></div>
                                </div>
                            </label>
                        ...
                        <div class="checkbox-grid">
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Маслянистый антикор для обработки скрытых полостей. Расход: до 5 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Антигравийное покрытие для защиты порогов и арок. Расход: до 3 кг.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Эластичный антигравий для порогов и арок. Расход: до 3 кг.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Восковой консервант для обработки скрытых полостей. Расход: до 5 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Шумоизоляция и защита арок и днища от влаги. Расход: до 3 кг.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Битумно-резиновое покрытие для защиты днища и арок. Расход: до 5 кг.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Классический мовиль для обработки скрытых полостей. Расход: до 5 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Антикоррозийная мастика для днища и арок. Расход: до 5 кг.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Мовиль с цинковыми добавками для усиленной защиты полостей. Расход: до 5 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Эластичный антигравий для порогов и арок (белый). Расход: до 3 кг.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Мовиль с конвертером ржавчины для обработки полостей. Расход: до 5 л.</small>
                            ...
                            <label>
                                ...
                                <div class="element-row">
                                    ...
                                    <small class="material-hint">Быстросохнущий битумный антикор для днища и арок. Расход: до 5 л.</small>
    ...
    const disassemblyItems = [
        ...
        ['Снятие+установка пластиковая защита днища', 2500]
    ];
    ...
    function calculateLaserModal() {
        ...
        document.querySelectorAll('#laser-modal-addons input:checked').forEach(i => {
            const rate = parseInt(i.dataset.rate) || 0;
            const price = totalArea > 0 ? Math.round(rate * totalArea * multiplier) : 0;
            if (price <= 0) return;
            services.push(i.parentElement.textContent.trim() + ' — ' + price.toLocaleString('ru-RU') + ' ₽');
            total += price;
        });
    ...
    function updateMaterialPreview() { 
        ...
        if (checked.length === 0) { preview.textContent = 'Материалы не выбраны'; preview.style.display = 'none'; } 
            ...
            const total = Array.from(checked).reduce((sum, el) => { const qty = parseFloat(el.parentElement.querySelector('.element-qty').value) || 1; const price = Math.round(parseInt(el.dataset.base) * 1.05 / 50) * 50; return sum + price * qty; }, 0); 
            const names = Array.from(checked).map(el => { const qty = parseFloat(el.parentElement.querySelector('.element-qty').value) || 1; return el.parentElement.querySelector('span').textContent.trim() + (qty > 1 ? ' (×' + qty.toLocaleString('ru-RU') + ')' : ''); });
    ...
    document.getElementById('calc-material-modal').addEventListener('click', function(e) { 
        if (e.target.classList.contains('element-qty-btn')) { 
            ...
            if (e.target.dataset.action === 'inc') { val = val + step; } else { val = Math.max(step, val - step); } 
    ...
    function calculateAnticorWork() {
        ...
        let liters = 0;
        materialChecked.forEach(el => { liters += parseFloat(el.parentElement.querySelector('.element-qty').value) || 1; });
